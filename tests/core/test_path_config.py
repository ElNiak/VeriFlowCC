...
class TestPathConfigBasics:
    ...
    def test_custom_base_directory(self, tmp_path):
    ...
    def test_base_directory_from_string(self, tmp_path):
...
class TestEnvironmentVariable:
    ...
    def test_env_var_with_explicit_base_dir(self, tmp_path):
    ...
    def test_env_var_with_home_expansion(self):
...
class TestPathResolution:
    ...
    def test_c4_diagrams_dir(self, tmp_path):
    ...
    def test_checkpoints_dir(self, tmp_path):
    ...
    def test_get_artifact_path_absolute_rejected(self, tmp_path):
    ...
    def test_get_artifact_path_parent_traversal_rejected(self, tmp_path):
...
class TestDirectoryCreation:
    ...
    def test_ensure_base_exists_creates_directory(self, tmp_path):
    ...
    def test_ensure_base_exists_idempotent(self, tmp_path):
    ...
    def test_ensure_structure_creates_config_files(self, tmp_path):
...
class TestPathConfigEquality:
    ...
    def test_equality_same_base_dir(self, tmp_path):
    ...
    def test_inequality_different_base_dir(self, tmp_path):
...
class TestTestIsolation:
    ...
    def test_create_isolated_instance(self, tmp_path):
    ...
    def test_with_test_isolation_context_manager(self, tmp_path):
    ...
    def test_cleanup_preserves_non_test_directories(self, tmp_path):
